...
export default function About() {
    return (
        <section data-aos="fade-up">
            ...
            <p className="my-5">I'm currently seeking Winter 2025 opportunities! Check out my resume <Link href="/resume-2b.pdf" target="_blank" rel="noopener noreferrer" className="hover:underline font-bold">here</Link>.</p>
