export default function About() {
    return (
        <section>
            ...
            <p className="my-5">I'm currently seeking Winter 2025 opportunies! Check out my resume here.</p>
            <p className="my-5">When I am not busy stuggling with cs assignment, you can find me sleeping, playing badminton, or exploring new place.</p>
        </section>
    )
}