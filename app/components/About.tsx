...
export default function About() {
    return (
        <section data-aos="fade-up">
            ...
            {/* <p className="my-5">I'm currently seeking Fall 2025 opportunities! Check out my resume <Link href="/resume_3b_external.pdf" target="_blank" rel="noopener noreferrer" className="hover:underline font-bold">here</Link>.</p> */}
