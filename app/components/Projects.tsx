    ...
    return (
        <section className="my-20" data-aos="fade-up">
            ...
            <div className="grid grid-cols-3 my-5">
                <div className="hvr-grow" data-aos="fade-up" data-aos-delay="100">
                ...
                <div className="hvr-grow" data-aos="fade-up" data-aos-delay="300">
                ...
                <div className="hvr-grow" data-aos="fade-up" data-aos-delay="500">
