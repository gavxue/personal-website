  ...
  return (
    <section className="my-20" data-aos="fade-up">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 my-5 gap-5">
        <Link
          href="https://github.com/gavxue/notefuse"
          className="hvr-grow"
          target="_blank"
        ...
        <Link
          href="https://github.com/gavxue/broken-link-checker"
          className="hvr-grow"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        {/* <Link
          href="https://github.com/gavxue/red-snap"
          className="hvr-grow"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <Link
          href="https://github.com/gavxue/face-recognition"
          className="hvr-grow"
          target="_blank"
          rel="noopener noreferrer"
        >
